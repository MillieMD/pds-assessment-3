    ...
    <div class = "main-body">
        ...
        <div class = "landing-image-wrapper">
            ...
            <div class = "stat-display-box">
                ...
                <?php
                    ...
                    $query = $db->prepare("SELECT count(DISTINCT entries.dog_id) as dogs, count(DISTINCT entries.competition_id) as events, count(DISTINCT dogs.owner_id) as owners 
                                           FROM entries, dogs 
                    ...
                    if($result === FALSE){
                        die("Apologies, no data for dog entries found");
                    }
        ...
        <div class = "gallery-container" id = "dog-gallery">
            ...
            <?php
                ...
                // Select the dogs name, breed, average score and owner details of the top 10 dogs
                $query = $db->prepare("SELECT dogs.id, dogs.name as dog, breeds.name as breed, AVG(score) as score, owners.id as owner_id, owners.name as owner, owners.email as email  
                                       FROM dogs, breeds, owners, entries  
                                       WHERE dogs.breed_id = breeds.id AND dogs.owner_id = owners.id AND entries.dog_id = dogs.id AND (SELECT COUNT(id) 
                                                                                                                                       FROM entries 
                                                                                                                                       WHERE dog_id = dogs.id GROUP BY dog_id) > 1
                ...
                if($result === FALSE){
                    die("Apologies, no competitor data has been found");
                }
                ...
                while ($row = $result->fetch_assoc()){
                    ...
                    echo("<div class = 'profile' id = 'profile-$i'>
                        ...
                        <div> 
                            <p class = 'profile-name'> " .$row['dog']. " </p>
                            <p class = 'profile-subtitle'> " .$row['breed']. " </p>
                            <p class = 'profile-score'>  " .$row["score"]. " </p>
                        </div>
        ...
        <!-- "More" button 
        (link to full dog list, alphabetised)-->
        <a href = "pages/dogs.php"><button class = "purple-button" style = "font-size: 1.5em;"> More </button></a>
