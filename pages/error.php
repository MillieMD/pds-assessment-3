  ...
  <body>
    ...
    <div class = "main-body">
        ...
        <?php
            ...
            if($_GET["error"] == null){ // if error is null, user was not sent here bt .htaccess --> redirect them to index page
                header("../index.php");
                exit;
            }
            ...
            switch($_GET["error"]){
                ...
                case("400"):
                    $msg = "Sorry, we could not complete your request right now. Please try again later";
                    break;
                ...
                case("403"): // Error 403 -forbidden
                    $msg = "Sorry, you are not allowed to access this resource";
                    break;

                case("404"):
                    $msg = "Sorry, that page could not be found. Please try again later";
                    break;

                default: // Generic 500 error if specific code not given
                    $error = "500";
            }

            echo("<h1> Error " .$error" - " .$msg. "</h1>");
        ?>
